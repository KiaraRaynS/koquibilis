...
from appfood.views import ClearShoppingListView, CookUploadedFoodView, SearchUploadedRecipesView
...
urlpatterns = [
    ...
    url(r'^searchuploads/(?P<user_id>\d+)/$', SearchUploadedRecipesView.as_view(), name='searchuploadedrecipesview'),
    ...
    url(r'^cookfood/uploads/(?P<recipe_id>\d+)/$', CookUploadedFoodView.as_view(), name='cookuploadedfoodview'),
